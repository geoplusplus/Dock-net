function [ Jittermean_aug,namelistcell_afteraug,gtbox_afteraug,gtlabel_afteraug,set_afteraug,imgsize_afteraug,boxesall_afteraug ] = ImgJitterAug( path,namelistcell,gtbox,gtlabel,set,imgsize,w_resize,h_resize,boxesall)
...
Jittermean_aug_batch=cell(1,batch_num);
...
parfor i=1:batch_num
    [ Jittermean_aug_batch{i},namelistcell_batch{i},gtbox_batch{i},gtlabel_batch{i},set_batch{i},imgsize_batch{i},boxesall_batch{i} ] =  ImgJitterAug_batch( path,namelistcell(batch_idx_cell{i}),gtbox(batch_idx_cell{i}),gtlabel(batch_idx_cell{i}),set(batch_idx_cell{i}),imgsize(batch_idx_cell{i},:),w_resize,h_resize,boxesall(batch_idx_cell{i}));
    %[ Jittermean_aug,namelistcell,gtbox,gtlabel,set,imgsize,boxesall ] = ImgJitterAug_batch( path,namelistcell,gtbox,gtlabel,set,imgsize,w_resize,h_resize,scalefactor,boxesall)
...
%     total_imgnum=total_imgnum+hsvmean_aug_batch{i}.num;
    meanR=(meanR*total_imgnum+Jittermean_aug_batch{i}.rmean*Jittermean_aug_batch{i}.num)...
        /(total_imgnum+Jittermean_aug_batch{i}.num);
    meanG=(meanG*total_imgnum+Jittermean_aug_batch{i}.gmean*Jittermean_aug_batch{i}.num)...
        /(total_imgnum+Jittermean_aug_batch{i}.num);
    meanB=(meanB*total_imgnum+Jittermean_aug_batch{i}.bmean*Jittermean_aug_batch{i}.num)...
        /(total_imgnum+Jittermean_aug_batch{i}.num);
    total_imgnum=total_imgnum+Jittermean_aug_batch{i}.num;
...
Jittermean_aug=struct('num',total_imgnum,'rmean',meanR,'gmean',meanG...
    ,'bmean',meanB);
