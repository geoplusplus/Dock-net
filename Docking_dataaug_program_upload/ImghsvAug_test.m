function [ hsvmean_aug,namelistcell,gtbox,gtlabel,set,imgsize,boxesall ] = ImghsvAug_test( path,namelistcell,gtbox,gtlabel,set,imgsize,w_resize,h_resize,boxesall,imgdata_aug )
